...
public:
	...
	// •`‰æ
	virtual void Draw(ID3D11DeviceContext* dc, const std::shared_ptr<Model> model) = 0;
...
public:
	...
	// •`‰æ
	virtual void Draw(const RenderContext& rc, const std::shared_ptr<Model> model) = 0;
